...
commits, code, wiki edits, issues, and other contributions that are not aligned with this Code of
...
For conduct enforcement, open a minimal issue titled `Private moderation contact requested`
without incident details or personal information, and ask the maintainers to establish a private
follow-up channel. Use GitHub's built-in block/report-abuse controls immediately when platform
safety is at risk. Vulnerability advisories are reserved for software security reports and are
not used for conduct complaints. All complaints will be reviewed and investigated promptly and
fairly.
