"""Compose deployment invariants for the v0.2.2 gateway release candidate."""
...
def test_production_compose_preserves_capacity_and_sidecar_invariants() -> None:
    """TC-DOCS-011: production Compose retains v0.2.2 capacity and sidecar wiring."""
    compose = _yaml(ROOT / "docker-compose.prod.yml")
    gateway = compose["services"]["gateway"]
    sidecar = compose["services"]["acme-guard"]

    assert gateway["image"] == "z-safety-gateway:0.2.2"
