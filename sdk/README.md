...
The gateway and SDK have independent version histories. Gateway v0.2.2 remains compatible with
the SDK v0.1.1 contract, so this release maintenance update does not require an SDK version bump.
